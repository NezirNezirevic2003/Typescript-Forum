...
exports.CREATE_USER = {
    type: Gebruiker_2.GebruikerType,
    args: {
    ...
    resolve: function (parent, args) {
        return __awaiter(this, void 0, void 0, function () {
            var naam, gebruikersnaam, wachtwoord;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        naam = args.naam, gebruikersnaam = args.gebruikersnaam, wachtwoord = args.wachtwoord;
                        return [4 /*yield*/, Gebruiker_1.Gebruiker.insert({
                                naam: naam,
